...
_core["default"].component({
  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _api.User.searchSchool(_this2.keyword, _this2.pageIndex, _this2.pageSize);
    ...
    onSelect: function onSelect(school) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                console.log(value);
                _this3.keyword = value;
                _context3.next = 7;
                return _api.User.searchSchool(_this3.keyword, _this3.pageIndex, _this3.pageSize);
...
}, {info: {"components":{"screen-dialog":{"path":"half-screen-dialog\\half-screen-dialog"},"searchbar":{"path":"searchbar\\searchbar"}},"on":{"75-0":["close"],"75-1":["input","cancel"]}}, handlers: {'75-0': {"close": function proxy () {
  ...
  }},'75-3': {"scrolltolower": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
