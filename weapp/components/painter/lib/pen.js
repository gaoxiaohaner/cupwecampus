...
function () {
  ...
  _createClass(Painter, [{
        ...
        case 'image':
          {
            ...
            var ratio = getApp().systemInfo.pixelRatio ? getApp().systemInfo.pixelRatio : 2; // 有css却未设置width或height，则默认为auto
    ...
    value: function _fillAbsText(view) {
      ...
      var _this$_preProcess3 = this._preProcess(view, view.css.background && view.css.borderRadius),
